...
public class ActionsMultiLevelMenuSubMenu15d {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		By level2Smenu = By.linkText("Beauty & Hygiene");
		By level3Smenu = By.linkText("Skin Care");
		By level4Smenu = By.linkText("Eye Care");
