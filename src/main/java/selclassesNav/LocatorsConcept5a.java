...
public class LocatorsConcept5a {
	static WebDriver driver; //this driver can be brought from BrowserUtility class as return

	public static void main(String[] args) {
		// LOCATORS: 2 types - By and String types

		// create a webelement+perform action on it(click, getText,
		// isDisplayed)--Formula
		// the complete page when u inspect is called chrome Dev Tools(the band with
		// multiple options)
		...
		// rest of the things that are in key, value format are attributes/properties
		// for the WE

		// whenever we hit the URL: the DOM is the first to be loaded which is written
		// in the form
		// of html
		// Every browser has some DOM api's which would read the particular browser-and
		// keep placing
		// the elements as per the content written
		// Dom will be coming first, then the html and page will be coming later
		// Dom is just to place the WEs on the page and not to define the funtionality
		// of WEs
...
//        pwd4id.sendKeys("EnPatiNagamma");
		...
		// 5.sendActions is repetitive in the previous approach-so Action utility also
		// needed:
...
//		doSendKeys(pwd, "EnPatiNagamma");
		...
		// which would be responsible for all the element creation and Actions on those
		// elements
		// To use the doSendKeys() --creating the object of ElementUtility class:
		//By locators also called Page locators or Object Repository
...
//		eleUtil.doSendKeys(pwd, "EnPatiNagamma");
		...
		//7. Approach is to combine both the browserUtility class and Element Utility class
